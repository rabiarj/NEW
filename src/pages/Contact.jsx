      ...
      <div className="row g-5">
        ...
        <div className="col-lg-6 wow fadeIn" data-wow-delay=".5s">
          <div className="p-5 rounded contact-form">
            ...
            <div className="mb-4">
              <input type="phone" className="form-control border-0 py-3" placeholder={t('Contact Number')} />
            </div>
            <div className="mb-4">
  ...
  <div className="container pt-5 pb-4">
    <div className="row g-5">
      <div className="col-lg-3 col-md-6">
        <Link to="">
          <h5 className="text-info fw-bold  d-block footer-font NameLogo">{t('Gulf Egyptian Construction Co.')}</h5>
        </Link>
        ...
        <div className="d-flex hightech-link mt-5 justify-content-center">
          ...
          <aLink to="" className="btn-light nav-fill btn btn-square rounded-circle me-2"><i className="fab fa-twitter text-primary" /></aLink>
      ...
      <div className="col-lg-3 col-md-6">
        ...
        <div className="mt-4 d-flex flex-column help-link">
          <Link to="" className="mb-2 text-white"><i className="fas fa-angle-right text-info me-2" />{t('Terms Of use')}</Link>
      ...
      <div className="col-lg-3 col-md-6">
        <Link to="#" className="h3 text-info">{t('Contact Us')}</Link>
        <div className="text-white mt-4 d-flex flex-column contact-link">
          ...
          <Link to="#" className="py-3 text-light border-bottom border-primary"><i className="fas fa-envelope text-info me-2" /> {t('gecconstruction@gmail.com')}</Link>
        </div>
      </div>
    </div>
